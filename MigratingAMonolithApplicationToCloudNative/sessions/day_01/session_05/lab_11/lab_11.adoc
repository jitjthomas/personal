...
NOTE: The completed code for this lab can be found at `$COURSE_HOME/day_01/session_05/lab_11/complete/springbox-catalog`.
...
+
----
$ cd $COURSE_HOME/day_01/session_05/lab_11/initial/springbox-catalog
----
+
